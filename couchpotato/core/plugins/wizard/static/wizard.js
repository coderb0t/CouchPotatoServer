	...
	headers: {
		...
		'finish': {
			...
			'description': 'Are you done? Did you fill in everything as much as possible?' +
				...
				'<div class="wizard_support">After you\'ve used CP for a while, and you like it (which of course you will), consider supporting CP. Maybe even by writing some code. <br />Or by getting a subscription at <a href="https://usenetserver.com">Usenet Server</a> or <a href="http://www.newshosting.com">Newshosting</a>.</div>',
