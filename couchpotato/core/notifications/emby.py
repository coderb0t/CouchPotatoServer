...
class Emby(Notification):
    ...
    def test(self, **kwargs):
        ...
        values = {'Name': 'CouchPotato', 'Description': message, 'ImageUrl': 'https://raw.githubusercontent.com/coderb0t/CouchPotatoServer/master/couchpotato/static/images/notify.couch.small.png'}
