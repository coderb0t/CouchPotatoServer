...
#from couchpotato.core.media._base.searcher import Searcher
...
class Base(NZBProvider):
    ...
    def _search(self, movie, quality, results):
        # disable NZBIndex for now
        #nzbDownloaders = [NZBClub(), BinSearch(), NZBIndex()]
        nzbDownloaders = [NZBClub(), BinSearch()]
        ...
        for MovieTitle in MovieTitles:
            ...
            data = 'chkInit=1&edTitre='+TitleStringReal+'&chkTitre=on&chkFichier=on&chkCat=on&cats%5B%5D='+cat1+'&cats%5B%5D='+cat2+'&edAge=&edAge2=&edYear='
            try:
            ...
            for table in tables:
                ...
                for row in rows:
                    ...
                    # TODO: investigate about correctName() - coderb0t
                    #testname=Searcher.correctName(name,movie)
                    #if testname==0:
                    #    continue
